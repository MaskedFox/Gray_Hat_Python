...
class debugger():
    ...
    def load(self, path_to_exe):
        ...
        # THE FOllowing two opetions allow the started process
        ...
        # We then initialize the cb variable in the STARRUPINFO struct
		...
		print("[*] We have successfully launched the process!")
	    	...
	    	#Obtain a valid hanlde to the newly created process
	...
	if snapshot is not None:
            #Yout have to set the size of the struct or the call will fail
